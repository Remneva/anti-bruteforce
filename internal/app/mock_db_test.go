...
// GetAllFromWhiteList mocks base method
func (m *MockListStorage) GetAllFromWhiteList(ctx context.Context) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllFromWhiteList", ctx)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllFromWhiteList indicates an expected call of GetAllFromWhiteList
func (mr *MockListStorageMockRecorder) GetAllFromWhiteList(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllFromWhiteList", reflect.TypeOf((*MockListStorage)(nil).GetAllFromWhiteList), ctx)
}

// GetAllFromBlackList mocks base method
func (m *MockListStorage) GetAllFromBlackList(ctx context.Context) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllFromBlackList", ctx)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllFromBlackList indicates an expected call of GetAllFromBlackList
func (mr *MockListStorageMockRecorder) GetAllFromBlackList(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllFromBlackList", reflect.TypeOf((*MockListStorage)(nil).GetAllFromBlackList), ctx)
}
